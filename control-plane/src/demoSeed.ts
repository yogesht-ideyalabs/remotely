...
const AWS_PROJECT: ProjectSeed = {
  ...
  resources: [
    ...
    },
    {
      ...
      tags: { Name: "aws-web-server-1", Environment: "production", Owner: "platform-team", Application: "storefront" },
      networkInfo: { vpcId: "vpc-aws01", subnetId: "subnet-aws-pub1", privateIps: ["10.0.1.10"], publicIps: ["54.23.11.9"], securityGroups: ["sg-aws01"] },
      relationships: [
        { targetResourceId: "subnet-aws-pub1", type: "runs-in" },
        { targetResourceId: "sg-aws01", type: "member-of" },
        { targetResourceId: "fn-aws-processor", type: "connects-to" },
      ],
    },
    {
      ...
      tags: { Name: "aws-app-server-1", Environment: "production", Owner: "platform-team", Application: "storefront" },
    ...
    },
    {
      ...
      tags: { Name: "aws-image-processor", Environment: "production", Application: "media-pipeline" },
      relationships: [{ targetResourceId: "aws-assets-bucket", type: "connects-to" }],
    },
    {
      ...
      tags: { Name: "aws-assets-bucket", Environment: "production", Application: "media-pipeline" },
      relationships: [],
    },
    {
      ...
      tags: { Name: "aws-prod-postgres", Environment: "production", Application: "storefront" },
    ...
    },
    {
      ...
      tags: { Name: "aws-prod-alb", Environment: "production", Application: "storefront" },
      networkInfo: { vpcId: "vpc-aws01" },
...
const AZURE_PROJECT: ProjectSeed = {
  ...
  resources: [
    ...
    },
    {
      ...
      tags: { Name: "azure-web-vm-1", Environment: "production", Owner: "platform-team", Application: "storefront" },
      ...
      relationships: [
        { targetResourceId: "subnet-azure-web", type: "runs-in" },
        { targetResourceId: "nsg-azure01", type: "member-of" },
        { targetResourceId: "fn-azure-notify", type: "connects-to" },
      ],
    },
    {
      ...
      tags: { Name: "azure-app-vm-1", Environment: "production", Owner: "platform-team", Application: "storefront" },
    ...
    },
    {
      ...
      tags: { Name: "azureprodassets", Environment: "production", Application: "media-pipeline" },
      relationships: [],
    },
    {
      ...
      tags: { Name: "azure-prod-sql", Environment: "production", Application: "storefront" },
    ...
    },
    {
      ...
      tags: { Name: "azure-notify-function", Environment: "production", Application: "media-pipeline" },
      relationships: [{ targetResourceId: "st-azureassets", type: "connects-to" }],
    },
    {
      ...
      tags: { Name: "azure-prod-lb", Environment: "production", Application: "storefront" },
      networkInfo: { vpcId: "vnet-azure01" },
...
const GCP_PROJECT: ProjectSeed = {
  ...
  resources: [
    ...
    },
    {
      ...
      tags: { Name: "gcp-web-instance-1", Environment: "production", Owner: "platform-team", Application: "storefront" },
      networkInfo: { vpcId: "vpc-gcp01", subnetId: "subnet-gcp-web", privateIps: ["10.20.1.5"], publicIps: ["34.72.11.4"], securityGroups: ["fw-gcp01"] },
      relationships: [
        { targetResourceId: "subnet-gcp-web", type: "runs-in" },
        { targetResourceId: "fw-gcp01", type: "member-of" },
        { targetResourceId: "fn-gcp-thumbnail", type: "connects-to" },
      ],
    },
    {
      ...
      tags: { Name: "gcp-app-instance-1", Environment: "production", Owner: "platform-team", Application: "storefront" },
    ...
    },
    {
      ...
      tags: { Name: "gcp-prod-assets", Environment: "production", Application: "media-pipeline" },
      relationships: [],
    },
    {
      ...
      tags: { Name: "gcp-prod-cloudsql", Environment: "production", Application: "storefront" },
    ...
    },
    {
      ...
      tags: { Name: "gcp-thumbnail-function", Environment: "production", Application: "media-pipeline" },
      relationships: [{ targetResourceId: "gke-gcp-worker", type: "connects-to" }],
    },
    {
      ...
      tags: { Name: "gcp-gke-worker-pod", Environment: "production", Application: "media-pipeline" },
      networkInfo: { vpcId: "vpc-gcp01", subnetId: "subnet-gcp-data", privateIps: ["10.20.2.20"] },
      relationships: [{ targetResourceId: "subnet-gcp-data", type: "runs-in" }, { targetResourceId: "gcs-gcp-assets", type: "connects-to" }],
    },
    {
      ...
      tags: { Name: "gcp-prod-lb", Environment: "production", Application: "storefront" },
      networkInfo: { vpcId: "vpc-gcp01" },
