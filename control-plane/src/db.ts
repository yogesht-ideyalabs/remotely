...
const TABLES = ["users", "roles", "connections", "organizations", "sshKeys", "accessRequests", "joinTokens", "agentIdentities", "siemConfig", "infraAccounts", "infraResources", "infraDiagrams", "infraDiagramVersions", "infraSnapshots", "webhookPlugins", "notificationState", "smtpConfig", "monitors", "monitorChecks", "dashboardLayouts", "securityPolicy", "bots"] as const;
