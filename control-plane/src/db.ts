...
const TABLES = ["users", "roles", "connections", "organizations", "sshKeys", "accessRequests", "joinTokens", "agentIdentities", "siemConfig", "infraAccounts", "infraResources", "infraDiagrams"] as const;
